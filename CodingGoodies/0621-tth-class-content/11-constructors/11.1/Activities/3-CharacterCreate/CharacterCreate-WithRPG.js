...
var warrior = new Character("Crusher", "Warrior", "Male", 25, 10, 750);
var rogue = new Character("Dodger", "Rogue", "Female", 23, 20, 500);


warrior.fallOnSword = function () {
    this.hitpoints = 0;
};
warrior.favoriteBlade = 'Butter Knife';
console.log('Warrior\'s sword', warrior.favoriteBlade);
warrior.fallOnSword();
warrior.printStats();
rogue.printStats();
