...
weather.find({search: "Anchorage, AK", degreeType: "F"}, function(err, result){
	...
	// If there is no error... then print out the weather data using JSON.stringify to print the data in string format.
	// The JSON.stringify argument of "2" to makes it pretty. 
